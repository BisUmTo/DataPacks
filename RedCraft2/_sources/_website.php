...
<ul>
    <li>Sistema di dormita multiplayer: basta che dorma un giocatore per far trascorrere la notte. Cliccando sul nome del giocatore che compare in chat, esso viene espulso dal letto.</li>
    ...
    <li>
        ...
        <ul>
            <li>Gettando addosso ad un'armor stand due <i>bastoni/sticks</i>, compariranno le braccia.</li>
            <li>Gettando addosso ad un'armor stand una <i>lastra di pietra/stone slab</i>, scomparir&agrave; la base.</li>
            <li>Gettando addosso ad un'armor stand una <i>piuma/feather</i>, essa non soffrir&agrave; più della gravit&agrave;.</li>
    ...
    <li>Modificato il drop delle shulker, ognuna dar&agrave; 2 <i>gusci di shulker/shulker shell</i>.</li>
