# bisumto.redcraft2:src/bots/brackets/3
...
execute at @a[scores={bot=2}] as @e[team=REDzbot,scores={REDBOTtmp=0},limit=1] run function bisumto.redcraft2:src/bots/brackets/4
...
execute as @a[scores={bot=1..},limit=1] run function bisumto.redcraft2:src/bots/brackets/3
