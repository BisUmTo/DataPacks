# bisumto.redcraft2:src/armorstandplus/brackets/4

execute as @e[type=armor_stand,limit=1,sort=nearest] store result score #TMP armorstandplus run data get entity @s Pose.Head[2]
