# bisumto.redcraft2:src/graves/brackets/3

summon armor_stand ~ ~-1.7 ~.25 {Tags:["REDgrv","REDgr2"],NoGravity:1b,Invisible:1,Invulnerable:1,ArmorItems:[{},{},{},{id:"minecraft:spruce_sign",Count:1b}],DisabledSlots:2039583}
