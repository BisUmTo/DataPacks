# bisumto.redcraft2:src/statustriggers/subfunctions/livetrigger/20gt
...
execute if entity @a[team=REDafk,scores={live=1}] run function bisumto.redcraft2:src/statustriggers/subfunctions/afktrigger/20gt

scoreboard players set @a[team=!REDlve,scores={live=1}] rec 0
execute if entity @a[team=REDrec,scores={live=1}] run function bisumto.redcraft2:src/statustriggers/subfunctions/rectrigger/20gt
