# bisumto.redcraft2:src/deathcoords/brackets/1
...
execute if entity @s[team=REDafk] run function bisumto.redcraft2:src/deathcoords/brackets/2
execute unless entity @s[team=REDafk] run function bisumto.redcraft2:src/deathcoords/brackets/3
