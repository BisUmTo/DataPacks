# bisumto.redcraft2:src/stackableshulkerboxes/1gt
...
execute as @e[tag=REDSSBprv,limit=1] at @s run function bisumto.redcraft2:src/stackableshulkerboxes/brackets/1
