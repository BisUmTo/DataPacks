# bisumto.redcraft2:src/stackableshulkerboxes/brackets/1
...
execute if score @s REDSSBstk matches 65..127 run function bisumto.redcraft2:src/stackableshulkerboxes/brackets/2
...
execute as @e[tag=REDSSBprv,limit=1] at @s run function bisumto.redcraft2:src/stackshulkerboxes/brackets/1
