# bisumto.redcraft2:src/beds/subfunctions/multiplayerbed/1gt

execute as @a store result score @s REDslp run data get entity @s SleepTimer
execute if score MultiplayerBedMessage config matches 1 as @a[scores={REDslp=1}] run function bisumto.redcraft2:src/beds/subfunctions/multiplayerbed/brackets/1
