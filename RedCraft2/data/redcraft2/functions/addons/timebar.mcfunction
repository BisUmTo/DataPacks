# redcraft2:addons/timebar

execute store result score Tempo timebar run time query daytime
execute store result bossbar redcraft2:timebar value run scoreboard players get Tempo timebar
execute if score Tempo timebar matches ..12541 run bossbar set redcraft2:timebar color yellow
execute if score Tempo timebar matches 23458.. run bossbar set redcraft2:timebar color yellow
execute if score Tempo timebar matches 12541..23458 run bossbar set redcraft2:timebar color blue

scoreboard players enable @a timebar
scoreboard players operation @a timebar %= 2 const
bossbar set redcraft2:timebar players @a[scores={timebar=1..}]
...
bossbar set redcraft2:timebar name [{"score":{"objective":"timebar","name":"Giorno"}},"g ",{"score":{"objective":"timebar","name":"Ore"}},":",{"score":{"objective":"timebar","name":"DecineMinuti"}},{"score":{"objective":"timebar","name":"Minuti"}},":",{"score":{"objective":"timebar","name":"DecineSecondi"}},{"score":{"objective":"timebar","name":"Secondi"}}]
