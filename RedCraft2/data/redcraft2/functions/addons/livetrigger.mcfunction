...
execute if entity @a[team=REDafk,scores={live=1}] run function redcraft2:addons/afktrigger

scoreboard players set @a[team=!REDlve,scores={live=1}] rec 0
execute if entity @a[team=REDrec,scores={live=1}] run function redcraft2:addons/rectrigger
