# redcraft2:src/graves/subfunctions/gravetrigger/20gt
...
execute at @a[scores={tomba=1..}] positioned ~ ~-1.7 ~ run function redcraft2:src/graves/subfunctions/gravetrigger/brackets/1
