# redcraft2:src/statustriggers/subfunctions/afktrigger/20gt
...
execute if entity @a[team=REDrec,scores={afk=1}] run function redcraft2:src/statustriggers/subfunctions/rectrigger/20gt

scoreboard players set @a[team=!REDafk,scores={afk=1}] live 0
execute if entity @a[team=REDlve,scores={afk=1}] run function redcraft2:src/statustriggers/subfunctions/livetrigger/20gt
