# redcraft2:src/statustriggers/subfunctions/rectrigger/20gt
...
execute if entity @a[team=REDafk,scores={rec=1}] run function redcraft2:src/statustriggers/subfunctions/afktrigger/20gt

scoreboard players set @a[team=!REDrec,scores={rec=1}] live 0
execute if entity @a[team=REDlive,scores={rec=1}] run function redcraft2:src/statustriggers/subfunctions/livetrigger/20gt
