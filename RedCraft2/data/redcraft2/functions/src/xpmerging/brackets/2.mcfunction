# redcraft2:src/xpmerging/brackets/2
...
execute if score @s REDEXPsco matches 32768.. run function redcraft2:src/xpmerging/brackets/3
...
tag @s add RUNNED
execute as @e[tag=REDEXPexp,tag=!RUNNED,limit=1] at @s run function redcraft2:src/xpmerging/brackets/2
