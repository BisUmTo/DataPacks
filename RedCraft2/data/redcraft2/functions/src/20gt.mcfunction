...
execute if score ArmorstandPlus config matches 1 run function redcraft2:src/armorstandplus/20gt
...
#0# execute if score Magnet config matches 1 run function redcraft2:src/magnet/20gt
...
execute if score StatusTriggers config matches 1 run function redcraft2:src/statustriggers/20gt
execute if score TimeBar config matches 1 run function redcraft2:src/timebar/20gt
