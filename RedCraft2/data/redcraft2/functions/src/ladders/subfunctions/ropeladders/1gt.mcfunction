# redcraft2:src/ladders/subfunctions/ropeladders/1gt
...
execute as @e[tag=REDRLDarm] at @s run function redcraft2:src/ladders/subfunctions/ropeladders/brackets/1
