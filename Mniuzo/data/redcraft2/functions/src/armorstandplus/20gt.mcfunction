# redcraft2:src/armorstandplus/20gt
...
execute as @e[type=item,nbt={Item:{id:"minecraft:smooth_stone_slab",Count:1b}},nbt=!{Age:6000s}] at @s store success entity @s Age short 6000 as @e[type=minecraft:armor_stand,limit=1,distance=..1,tag=!REDASP002] run data merge entity @s {NoBasePlate:1b}
